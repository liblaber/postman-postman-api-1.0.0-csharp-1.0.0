...
public record UpdateMonitorRequest(
    [property:
        ...
        UpdateMonitorRequest.UpdateMonitorMonitor1? Monitor = null
)
{
    public record UpdateMonitorMonitor1(
        ...
        [property:
            ...
            UpdateMonitorMonitor1.MonitorSchedule3? Schedule = null
    )
    {
        /// <summary>Information about the monitor's schedule.</summary>
        public record MonitorSchedule3(
            /// <value>
