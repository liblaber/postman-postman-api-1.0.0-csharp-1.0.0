...
public record CreateCollectionRequestOkResponse(
    /// <value>Information about the created request. For a complete list of properties, refer to the `definitions.request` property in the [collection.json schema file](https://schema.postman.com/collection/json/v1.0.0/draft-07/collection.json).</value>
    [property:
