...
public record DeleteCollectionResponse(
    ...
    [property:
        ...
        object? Meta = null,
    /// <value>The response's information.</value>
    [property:
        JsonPropertyName("data"),
        JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)
    ]
        DeleteCollectionResponse.DeleteCollectionResponseData? Data = null,
...
{
    /// <summary>The response's information.</summary>
    public record DeleteCollectionResponseData(
        /// <value>The response's ID.</value>
        [property:
            JsonPropertyName("id"),
            JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)
